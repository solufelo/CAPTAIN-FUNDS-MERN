...
function SettingsPage() {
  ...
  const onNotificationFinish = async (values: NotificationSettings) => {
    try {
      ...
      await axios.put("/api/users/settings/notifications", values, {
  ...
  const onPrivacyFinish = async (values: PrivacySettings) => {
    try {
      ...
      await axios.put("/api/users/settings/privacy", values, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const onSecurityFinish = async (values: SecuritySettings) => {
    try {
      ...
      await axios.put("/api/users/settings/security", values, {
        headers: { Authorization: `Bearer ${token}` },
      });
